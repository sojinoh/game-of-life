...
You can test the correctness of your rules by running the "ConwayTest.java" JUnit tests.  To do so, right click (or control-click) on "ConwayTest" and select Run 'ConwayTest'.  If a test files, you can look at ConwayTest.java to see the conditions under which it is failing.
